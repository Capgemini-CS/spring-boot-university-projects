...
public class ProjectService {
    ...
    List<Project> projectsList = List.of(new Project(1, "Data Modeling", false),
                                         new Project(2, "Petshop online", true),
                                         new Project(3, "Web Application", false)
    );
    ...
    public ProjectDto getProjectById(int id){
        ...
        for(Project project : projectsList){
            if(project.getId() == id){
                ...
                Logger.error("Project with given id doesn't exist.");
                throw new NoSuchProjectException("Project with given id doesn't exist.");
            }
        }
        return projectDto;
    }
